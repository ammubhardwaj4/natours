...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW1tdWJoYXJkd2FqNCIsImEiOiJjazBtcHEyMHMxNXY1M2dzdnd5NW5vYTBsIn0.fdrS2QL6q8IO_UDQrO-msQ';
...
// It works for both data and password.
var updateSettings =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
...
var stripe = Stripe('pk_test_NQxH18Ukls5qd68FqwV2DSc0');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('err', _context.t0);
